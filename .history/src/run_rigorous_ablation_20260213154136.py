...
class AdapterWrapper:
    ...
    def fit(self, X, y, ite_train=None, egfr_train=None, X_val=None, y_val=None, ite_val=None, egfr_val=None):
        self.model.train()
        ...
        for ep in range(1, self.epochs + 1):
            ...
            if self.joint_selection and X_val is not None and y_val is not None:
                if ep >= self.joint_warmup and (ep % self.joint_eval_interval == 0):
                    ...
                    joint_score = self._joint_score(val_metrics)
                    print(
                        ...
                        f"thr={val_metrics['BestThresh']:.2f}",
                        flush=True
                    )
...
def main():
    ...
    for seed in seeds:
        ...
        model_sota.fit(X_train, y_train, ite_train, egfr_train, X_val, y_val, ite_val, egfr_val)
