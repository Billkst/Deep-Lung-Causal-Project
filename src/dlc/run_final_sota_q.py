...
# Fixed Params (SOTA Candidate Config S - Longer Training, Tuned Balance)
PARAMS = {
    'd_hidden': 128,     # Low Param Base
    'num_layers': 3,     # Config N arch
    'lambda_hsic': 0.1,  # Balanced Reg
    'lambda_pred': 3.5,  # Strong Pred
    'lambda_ite': 1.0,   # Standard ITE
    'lambda_cate': 2.0,  # Strong CATE focus
    ...
    'lr_pre': 1e-4,
    'lr_fine': 3e-5,     # Slower fine tuning
    'bs_pre': 512,
    'bs_fine': 128,
    'epochs_pre': 200,   # Much Longer training
    'epochs_fine': 100,  # Much Longer fine tuning
    'warmup_epochs': 20,
