...
# Fixed Params (SOTA Candidate Config P - Tuned CATE/AUC, Low Params)
PARAMS = {
    'd_hidden': 128,     # Low Param Base
    'num_layers': 4,     # Deeper for CATE
    'lambda_hsic': 0.1,  # Balanced Reg
    'lambda_pred': 2.0,  # Strong Pred (AUC)
    'lambda_ite': 1.0,   # Standard ITE
    'lambda_cate': 2.0,  # Strong CATE focus (Recovery)
    'lambda_prob': 1.0,  # Standard
    'lambda_age': 0.0,
    'lambda_sens': 0.0,
    'lambda_adv': 0.5,
    'sens_eps_scale': 0.0,
    ...
    'lr_pre': 1e-4,
    'lr_fine': 5e-5,
    'bs_pre': 512,       # Increased for GPU utilization
    'bs_fine': 128,      # Increased for GPU utilization
    'epochs_pre': 130,   # Longer training
    'epochs_fine': 60,   # Longer fine tuning
    'warmup_epochs': 15,
    'lambda_pred_warm': 2.0,
